...
# NOTE: Server environment definitions has all required field to be seen
#       as definition of user ("duck typing").
...
# NOTE: SCADA client environments use primary user account.
#       Moreover, the whole setup applies only to Windows.
{% set selected_user = pillar['system_hosts'][grains['id']]['primary_user'] %}
