...
{% set selected_host = { 'hostname': host_config['hostname'], 'username': account_conf['username'], 'password_secret': account_conf['password_secret'] } %}
...
# Compose expected data object:
{% set selected_host = { 'hostname': host_config['hostname'], 'username': user_config['username'], 'password_secret': user_config['password_secret'] } %}
...
# Compose expected data object:
{% set selected_host = { 'hostname': hostname, 'username': user_config['username'], 'password_secret': user_config['password_secret'] } %}
