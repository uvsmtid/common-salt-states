...
echo %PATH% | findstr /I /C:";%CYGWINBINDIR%;" > nul || setx -m PATH "%PATH%;%CYGWINBINDIR%;"
...
{#
DISABLED: This is part of stand-alone Cygwin installation package which is
          now instaled using Salt states.
#}
{% if False %}

REM Install project_name-specific software:
