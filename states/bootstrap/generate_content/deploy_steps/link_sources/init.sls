    ...
    file.blockreplace:
        ...
        - content: |
            {{ deploy_step }} = {
                ...
                'projects_states_repo_abs_paths': {{ target_env_pillar['properties']['projects_states_repo_paths'] }},
                'overrides_bootstrap_target_profile_pillars_repo_abs_path': '{{ target_env_pillar['properties']['repo_path_bootstrap_target_profile_pillars'] }}',
